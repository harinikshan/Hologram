...
public class embdes_logo extends AppCompatActivity {
  ...
  /*  private void updateTextView() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num2.setText("127");
                num2.animate().rotationX(180f).scaleX(1f).scaleY(1f).setDuration(1000);
        num3.setText("127");
        num3.animate().rotationY(180f).scaleX(1f).scaleY(1f).setDuration(1000);
        num4.setText("127");
                num4.animate().scaleX(1f).scaleY(1f).rotationX(180f).setDuration(1000);;
        ImageView logoimageView = (ImageView) findViewById(R.id.logoimageView);
        logoimageView.animate().scaleX(1f).scaleY(1f).rotationY(180f).setDuration(1000);
        ImageView logoimageView2 = (ImageView) findViewById(R.id.logoimageView2);
        logoimageView2.animate().scaleX(1f).scaleY(1f).rotationX(180f).setDuration(1000);
        ImageView logoimageView3 = (ImageView) findViewById(R.id.logoimageView3);
        logoimageView3.animate().scaleX(1f).scaleY(1f).rotationX(180f).setDuration(1000);
        ImageView logoimageView4 = (ImageView) findViewById(R.id.logoimageView4);
        logoimageView4.animate().scaleX(1f).scaleY(1f).rotationY(180f).setDuration(1000);
