...
public class SplashScreen extends Activity {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                splashimageView3.animate().scaleX(1f).scaleY(1f).rotationX(360f).setDuration(5000);
                ImageView splashimageView4 = (ImageView) findViewById(R.id.splashimageView12);
                splashimageView4.animate().scaleX(1f).scaleY(1f).rotationY(360f).setDuration(5000);
